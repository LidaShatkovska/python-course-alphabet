...
def task_9_count_customers_by_country_with_than_10_customers(cur):
    ...
    Returns: 3 records
    """
    cur.execute("SELECT count(CustomerID), City FROM Customers GROUP BY City HAVING count(CustomerID)>10")
    return cur.fetchall()
...
def task_16_match_all_customers_and_suppliers_by_country(cur):
    ...
    """
    cur.execute(
        '''SELECT Customers.CustomerName, Customers.Address, Customers.Country customerCountry, 
                  Suppliers.Country supplierCountry, Suppliers.SupplierName
           FROM Customers 
